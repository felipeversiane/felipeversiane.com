    ...
    <div className="flex items-center justify-between w-full">
      <Link href="/" className="flex gap-2.5 items-center justify-start">
        <Avatar className="shadow-lg">
          <AvatarImage src="/images/perfil.svg" width={50} height={50} />
          <AvatarFallback>FV</AvatarFallback>
        </Avatar>
        <div className="flex flex-col items-start justify-start">
          <p className="gap-1.5 relative top-1 flex font-normal text-[17px]">
            <span>{t("first_name")}</span>
            <span>{t("secondary_name")}</span>
          </p>
          <p className="font-regular text-[15px] text-primary">{t("index")}</p>
        </div>
      </Link>
